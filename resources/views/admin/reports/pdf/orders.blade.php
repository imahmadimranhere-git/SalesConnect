...
<body>
    ...
    <h2>{{ $companyName }}</h2>
    <div class="subtitle">Order Report — {{ \Carbon\Carbon::parse($from)->format('d M Y') }} to {{ \Carbon\Carbon::parse($to)->format('d M Y') }}</div>
    ...
    <table>
        ...
        <tbody>
            ...
            @empty
                <tr><td colspan="6">No orders in this date range.</td></tr>
            @endforelse
        </tbody>
    </table>
