    ...
    <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="mt-4">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 mb-3">
                ...
                <input type="text" name="category" value="{{ old('category', $product->category) }}" class="form-control @error('category') is-invalid @enderror">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 mb-3">
                ...
                <input type="number" name="stock_quantity" value="{{ old('stock_quantity', $product->stock_quantity) }}" class="form-control @error('stock_quantity') is-invalid @enderror">
        ...
        <div class="mb-3">
            ...
            @if ($product->image)
                <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="mt-2 d-block rounded" style="height: 60px;">
            @endif
        </div>
