...
@section('content')
    ...
    <form method="GET" class="bg-white p-3 rounded shadow-sm mb-4">
        <div class="row g-2 align-items-end">
            ...
            <div class="col-6 col-md-2">
                <a href="{{ route('distributor.reports.orders.export', ['date_from' => $from, 'date_to' => $to]) }}" class="btn btn-sm btn-outline-danger w-100">
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover align-middle bg-white">
            ...
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="text-center">No orders in this date range.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
